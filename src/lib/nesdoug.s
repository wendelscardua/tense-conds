...
.proc _multi_vram_buffer_vert
  ...
  jmp _multi_vram_buffer_horz::_multi_vram_buffer_common
.endproc

;void one_vram_buffer(unsigned char data, int ppu_address);
.proc _one_vram_buffer
  ldy VRAM_INDEX
  sta VRAM_BUF+1, y
  txa
  sta VRAM_BUF, y
